                            ...
                            <div className="p-6 lg:p-8 w-full text-center">
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                    <a
                                        ...
                                        className="sm:w-1/2 bg-gray-800 hover:bg-purple-800 text-gray-300 px-4 py-2 rounded-xl text-sm sm:text-base lg:text-lg font-semibold transition-colors"
                                    >
                                        View Code
                                    </a>
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="sm:w-1/2 bg-purple-600 hover:bg-purple-800 text-white px-4 py-2 rounded-xl text-sm sm:text-base lg:text-lg font-semibold transition-colors"
                                    >
                                        View Live
                                    </a>
                                </div>
